      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            ...
            От разработки идеи до финального монтажа.{' '}
          ...
          <div className="text-center">
            <h1 className="flex flex-col items-center text-5xl font-semibold wrap-balance tracking-tight text-balance text-white sm:text-7xl gap-2">
            Видео – продакшн полного цикла для вашего проекта
            </h1>
